...
class Dashboard {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex flex-wrap gap-2 mt-3">
                                            <button class="btn btn-outline-primary" onclick="SectionManager.loadSection('financial-statements')">
                                                <i class="fas fa-file-invoice-dollar me-1"></i> Financial Statements
                                            </button>
                                            <button class="btn btn-outline-success" onclick="SectionManager.loadSection('financial-analysis')">
                                                <i class="fas fa-chart-line me-1"></i> Ratio Analysis
                                            </button>
                                            <button class="btn btn-outline-warning" onclick="SectionManager.loadSection('compliance')">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="mb-2">
                                                ...
                                                <span>${Object.keys(appState.allJSONData).length} of 26</span>
                                            </p>
                                            <p class="mb-0">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="Dashboard.addNewCompany()">Add Company</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    static addNewCompany() {
        ...
        if (!newId || isNaN(newId) || parseInt(newId) <= 0) {
            Notifications.show('Please enter a valid company ID number', 'error');
            return;
        }

        const companyId = parseInt(newId);
        if (appState.availableCompanies.includes(companyId)) {
            Notifications.show(`Company ${companyId} is already in the list`, 'warning');
            return;
        }
